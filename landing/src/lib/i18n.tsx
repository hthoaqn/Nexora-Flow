...
const dict = {
  vi: {
    ...
    navCta: "Bắt đầu",
    navSignIn: "Đăng nhập",
    eyebrow: "AI deal-flow · có bằng chứng",
    heroTitle1: "Từ pitch deck",
    heroTitle2: "đến đúng cuộc họp.",
    heroLead:
      "Chuẩn hóa hồ sơ, xếp hạng đối tác theo thesis, giải thích fit score — soạn intro và đặt lịch. AI gợi ý, con người duyệt.",
    ...
    problemBody:
      "Email lạnh, danh bạ cũ và tìm kiếm thủ công làm chậm cả startup lẫn quỹ. Nexora Flow chuẩn hóa hồ sơ, match có giải thích, rồi hỗ trợ giới thiệu đến cuộc họp.",
    ...
    matchTags: ["Lĩnh vực khớp", "Giai đoạn Seed", "SEA"],
  ...
  en: {
    ...
    navCta: "Join",
    navSignIn: "Sign in",
    eyebrow: "AI deal-flow · evidence-bound",
    heroTitle1: "From pitch deck",
    heroTitle2: "to the right meeting.",
    heroLead:
      "Standardize profiles, rank partners by thesis, explain every fit score — then draft the intro and book the slot. AI suggests. Humans approve.",
    ...
    problemBody:
      "Deal flow today is cold emails, stale directories and luck. Nexora Flow reads your deck, understands what you actually need, and finds the one partner built for it — then writes the intro and books the meeting itself.",
